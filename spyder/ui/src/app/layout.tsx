...
import { Toaster } from "sonner"; // Import toast notifications
import "./globals.css";
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${roboto.className}`}>
        <ThemeProvider> {/* Provides the dark/light Next.js theming */}
          <noscript>You need to enable JavaScript to run this app.</noscript>
          <div id="root">{children}</div>
          <Toaster position="top-right" /> {/* Add the toast notifications here */}
        </ThemeProvider>
      </body>
    </html>
  );
